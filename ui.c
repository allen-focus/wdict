...
{
    MEM_TRACK("[mem] ui box_cache arena = MB(%lld)\n", (long long)(BOX_CACHE_ARENA_CAPACITY / (1024 * 1024)));
...
{
    MEM_TRACK("[mem] ui context arena = MB(%lld)\n", (long long)(UI_CONTEXT_ARENA_CAPACITY / (1024 * 1024)));
...
// NOTE: Currently not used, but it is important and will be used in the future.
